...
/**
 * 参考URL：http://blog.csdn.net/qq_24400639/article/details/51602646
 * 
 * @author ygm
 */
public class IndexField {
	 ...
	 * @return
	 */
	public IndexField setSearchIKAnalyzer() {
		map.put("search_analyzer", "ik_max_word");
		return this;
	}
	...
	/**
     * 在分词到字段上支持keyword,并且字符长度超过256的部分不索引
	 *
	 * @return
     */
	public IndexField setFieldKeywordWithIgnore() {
		map.put("fields", Field.make().setType(DataType.KEYWORD).setIgnoreAbove());
		return this;
	}
	 ...
	 *
	 * @param format yyy-MM-dd HH:mm:ss||yyyy-MM-dd||epoch_millis
	 * @return
	 */
	 ...
	 * @return
	 */
	public IndexField setFormat() {
		this.map.put("format", "yyy-MM-dd HH:mm:ss||yyyy-MM-dd||epoch_millis");
		return this;
	}
